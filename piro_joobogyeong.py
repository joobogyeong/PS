...
class DetectiveGame:
    ...
    def show_intro(self):
        ...
        self.dying_message = f"{attribute_name} {getattr(self.murderer, dying_message_type)} 윽..☠️"
        ...
        # 이 줄부터 코드를 작성해주세요!
        print(f"총 용의자는 {len(self.characters)}명입니다.")
        ########################################################
        time.sleep(1)
    ...
    def investigate(self):
        ...
        for char in self.characters:
            if char.name == choice_name:
                self.clues.append(char)
                print(f"\n{char.name}: 나의 머리는 {char.hair}, 옷은 {char.clothes}, 신발은 {char.shoes}")
                return
        #####################################################################################
